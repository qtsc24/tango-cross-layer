...
int main (int argc, char ** argv) 
{
    ...
    for (step = 0; step < 1; step++)
    {
        ...
        sprintf (fname, "larger_data/current_data/data32X/xgc.3d.08000.bp");
...
//    printf ("\n");
        ...
        ADIOS_FILE * fmesh = adios_read_open_file ("larger_data/current_data/data32X/xgc.mesh.bp", method, comm);
